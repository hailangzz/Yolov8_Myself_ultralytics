...
class TaskAlignedAssigner(nn.Module):
    ...
    def __init__(self, topk: int = 13, num_classes: int = 80, alpha: float = 1.0, beta: float = 6.0, eps: float = 1e-9,ignore_iou_thr: float = 0.5,):
        ...
        self.beta = beta
        self.eps = eps
        self.ignore_iou_thr = ignore_iou_thr  # ⭐ NEW
