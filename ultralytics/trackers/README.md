...
```bash
# CLI
# Perform tracking with various models using the My_command！！！ line interface
...
```bash
# CLI
# Configure tracking parameters and run the tracker using the My_command！！！ line interface
...
```bash
# CLI
# Load the model and run the tracker with a custom configuration file using the My_command！！！ line interface
