...
results = model.train(data="/home/chenkejing/PycharmProjects/ultralytics/ultralytics/cfg/datasets/cross_database_multis-seg.yaml", epochs=3, imgsz=640, device=-1, workers=0, batch=32, project="runs/my_cross_database_exp", name="yolov8_focus_v")
