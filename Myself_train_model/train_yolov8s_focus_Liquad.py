...
# 训练线材检测模型
model = YOLO(
    "/home/chenkejing/PycharmProjects/ultralytics/ultralytics/cfg/models/v8/yolov8s_focus_Liquad.yaml"
...
results = model.train(
    ...
    multi_scale=True,
    cache=True,
    project="runs/my_liquid_exp",
    name="yolov8_focus_v_960P_",
)
