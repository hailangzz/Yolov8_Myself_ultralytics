...
# 训练线材检测模型
model = YOLO("/home/chenkejing/PycharmProjects/ultralytics/ultralytics/cfg/models/v8/yolov8s_focus_Liquad.yaml")  # load a pretrained model (recommended for training)
...
model.load("/home/chenkejing/PycharmProjects/ultralytics/yolov8s.pt")
results = model.train(data="seg_liquid_local.yaml", epochs=300, imgsz=960, device=-1, workers=6, batch=8, augment=True, multi_scale=True, cache=True, project="runs/my_liquid_exp", name="yolov8_focus_v_960P_")
