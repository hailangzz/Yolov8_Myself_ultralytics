...
# 训练线材检测模型
model = YOLO("/home/chenkejing/PycharmProjects/ultralytics/ultralytics/cfg/models/v8/yolov8s_focus_edge_wire.yaml")  # load a pretrained model (recommended for training)
model.load("/home/chenkejing/PycharmProjects/ultralytics/yolov8s.pt")
results = model.train(data="wire_detect.yaml", epochs=1, imgsz=640, device=-1, workers=0, batch=2, project="runs/my_wire_exp", name="yolov8_focus_v2")
