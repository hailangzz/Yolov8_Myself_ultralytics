...
yolo segment train \
    ...
    amp=True \
    project=runs/my_wire_seg_exp \
    name=yolov8s_wire_seg_v2_resume \
    save=True \
    save_period=15 \
    mosaic=0.5 \
    mixup=0.1 \
...
yolo segment train \
    ...
    ✅ 给你改好的 finetune 版本（第一阶段）
        ...
        yolo segment train \
            ...
            pretrained=/workspace/runs/my_wire_seg_exp/yolov8s_wire_seg_v2_6/weights/last.pt \
            epochs=90 \
            imgsz=960 \
            batch=48 \
            workers=4 \
    ...
    ✅ 第二阶段 finetune（解冻部分backbone层，当前冻结7层）
        ...
        yolo segment train \
            model=/workspace/data/TrainingScript/wire_seg/yolov8-seg_focus_wire_0330.yaml \
            data=/workspace/data/TrainingScript/wire_seg/seg_wire_finetune.yaml \
            pretrained=runs/my_wire_seg_exp/yolov8s_wire_seg_finetune_stage14/weights/best.pt \
            epochs=100 \
            imgsz=960 \
            batch=48 \
            workers=4 \
